...
📋 Table of Contents
1.	App Overview & Problem Solved
2.	Live Deployment
3.	Features List
4.	AI Feature & System Prompt
5.	Tools, Services & AI Models
6.	App Screenshots
...
Icons	Lucide React
AI Vision Model	Google Gemini 1.5 Flash Vision API / Multimodal LLM
...
Bash
git clone https://github.com/zainabaqeel/vibecheck.git
cd vibecheck
